  ...
  inputSchema: z.object({
    ...
    category: z
      ...
      .describe(
        ...
        Use the getAllCategories tool to get all valid categories.`,
      ),
  }),
...
export const getProductDetails = tool({
  description: `Get detailed information about a specific product in the Vercel swag store.
    Use this when the user asks for more information about a product, such as its description, images, price, and availability.`,
  inputSchema: z.object({
    productId: z
      .string()
      .describe("The ID of the product to retrieve details for."),
  }),
